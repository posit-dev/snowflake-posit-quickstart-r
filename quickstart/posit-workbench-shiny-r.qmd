...
In your Snowflake account, Go to `Data Products` > `Apps` to open the Native Apps collection.

![](assets/snowflake/05-apps.png)

### Step 2: Open the Posit Workbench Native App

Click the Open button next to the Posit Workbench app. If you do not see the Posit Workbench app listed, ask you Snowflake account administrator for access to the app.
...
![](assets/posit_workbench/03-snowflake-authentication.png).
